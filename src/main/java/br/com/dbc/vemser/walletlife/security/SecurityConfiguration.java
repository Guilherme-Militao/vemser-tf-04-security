    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.headers().frameOptions().disable().and()
                ...
                .authorizeHttpRequests((authz) ->  authz
                        ...
                        .antMatchers(HttpMethod.GET, "/receita/valor-total").hasAnyRole("ADMIN", "USUARIO")
                        .antMatchers(HttpMethod.GET, "/receita/total-registros").hasAnyRole("ADMIN", "USUARIO")
                        .antMatchers(HttpMethod.POST, "/receita/criar-receita").hasAnyRole("ADMIN", "USUARIO")
                        ...
                        .antMatchers(HttpMethod.GET, "/investimentos/valor-total").hasAnyRole("ADMIN", "USUARIO")
                        .antMatchers(HttpMethod.GET, "/investimentos/total-registros").hasAnyRole("ADMIN", "USUARIO")
                        .antMatchers(HttpMethod.POST, "/investimentos/criar-investimento").hasAnyRole("ADMIN", "USUARIO")
                        ...
                        .antMatchers(HttpMethod.GET, "/despesa/valor-total").hasAnyRole("ADMIN", "USUARIO")
                        .antMatchers(HttpMethod.GET, "/despesa/total-registros").hasAnyRole("ADMIN", "USUARIO")
                        .antMatchers(HttpMethod.POST, "/despesa/criar-despesa").hasAnyRole("ADMIN", "USUARIO")
